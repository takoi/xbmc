...
namespace XBMCAddon
{
  namespace xbmcwsgi
  {
    ...
    typedef Tuple<void*, void*, void*> WsgiExcInfo;
    ...
    public:
       ...
       * TODO
       */
      WsgiResponseBody* operator()(const String& status, const std::vector<WsgiHttpHeader>& response_headers /* TODO: , const WsgiExcInfo* exc_info = NULL */);
